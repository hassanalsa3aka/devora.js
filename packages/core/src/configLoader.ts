/**
 * CLI-only re-export, deliberately separate from the main `@devora/core`
 ...
 * build that imported *anything* from `@devora/core` (even just
 ...
 * separate `pnpm --filter @devora/core build` (real `tsc`, see that
